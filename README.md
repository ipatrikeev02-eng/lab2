...
3. **Генерация остальных n элементов**
   ...
   Начинаем цикл for. Для каждого последующего элемента (от индекса 'i=1' до 'i=n' ) применяется условный оператор  if:
    если 'i' нечётное ('i%2 == 1'), то к текущеt значениt x целочисленно делится на 4 ('x = x/4')
